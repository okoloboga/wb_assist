...
Реализовать возможность выбора AI модели (GPT-4o-mini или Claude Sonnet 3.5) для каждого пользователя индивидуально. Выбранная модель будет использоваться для:
- AI-ассистента (RAG)
- Аналитики продаж
- Генерации контента
...
5. Установить `gpt-5.1` как модель по умолчанию
...
4. По умолчанию используется gpt-5.1

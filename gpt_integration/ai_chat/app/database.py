"""
Database configuration for AI Chat Service.
...
# 1. AI_CHAT_DATABASE_URL (dedicated for this service)
# 2. DATABASE_URL (shared with main server)
# 3. SQLite fallback for development
DATABASE_URL = os.getenv(
    "AI_CHAT_DATABASE_URL",
    os.getenv("DATABASE_URL", "sqlite:///./ai_chat.db")
)

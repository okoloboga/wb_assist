...
1. **Ключевые метрики** (`key_metrics`):
   - Продажи по периодам (сегодня, вчера, 7 дней, 30 дней)
   - Динамика изменений (рост/падение в %)
   - Средний чек
   - Топ товары по продажам

2. **Аномалии** (`anomalies`):
   - Критичные остатки товаров
   - Нулевые остатки
   - Резкие изменения продаж
   - Проблемные позиции
...
4. **Рекомендации** (`recommendations`):
   ...
   - Приоритетные задачи по остаткам
...

{
  "key_metrics": {
    ...
    "sales_summary": {
      ...
      "7_days": {"count": 0, "amount": 0.0},
      "30_days": {"count": 0, "amount": 0.0}
    },
    "dynamics": {
    ...
    "top_products": [
      {"name": "string", "sales_count": 0, "revenue": 0.0, "rating": 0.0}
    ]
  },
  "anomalies": [
    {
      "type": "low_stock|zero_stock|sales_drop",
      "description": "string",
...
• Сегодня: 63 продаж на сумму 604 372₽
• Вчера: 194 продажи на сумму 1 720 055₽
• За 7 дней: 63 продажи на сумму 604 372₽
• За 30 дней: 446 продаж на сумму 3 890 241₽


📉 ДИНАМИКА

• Упали на 67.53% по сравнению с вчера
• За неделю изменений нет
• Средний чек: 9 593.21₽


🛍️ ТОП ТОВАРОВ

1. Платья — 8 продаж, 68 784₽, рейтинг 3.0
2. Платья — 6 продаж, 48 600₽, рейтинг 5.0
3. Пиджаки — 5 продаж, 116 445₽, рейтинг 5.0
4. Блузки — 4 продажи, 12 000₽, рейтинг 5.0
5. Пиджаки — 3 продажи, 31 500₽, рейтинг 5.0


⚠️ ЗАПАСЫ

• Критичные остатки: 33
• Нулевые остатки: 15
• Всего товаров: 82
...
• 📉 Продажи упали — проверьте рекламу
• 📦 15 товаров с нулевыми остатками
• ⚠️ 33 товаров с критичными остатками
```

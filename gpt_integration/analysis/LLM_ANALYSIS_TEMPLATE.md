...
3. **Инсайты** (`insights`):
   - **Анализ за N дней** (используй `daily_trends.time_series`):
...
- **ИНСАЙТЫ:** должны опираться на `daily_trends.time_series` — анализ динамики за N дней, сравнение вчера с общим трендом (5–7 инсайтов)
